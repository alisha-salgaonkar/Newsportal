...
<?php foreach ($news as $news_item): ?>
    ...
    <div>
	    <a href="<?php echo base_url().'index.php/news/showReasons/'.$news_item['n_id'] ?>"><input class="button small gradient orange rnd8" type="button" value="Reasons for Report"></a>
