...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2016 at 07:02 PM
...
(25, 'rrryuhukhly??', 22, '2016-01-04', '11:01:01', 1, 0, 0, 0);
...
(55, 'alisha', NULL, '', '0000-00-00', 0, '', 'citizen', 'alishasalgaonkar@gmail.com');
...
(26, 'image/jpeg', 'uploads/Koala3.jpg', 63),
(27, 'image/jpeg', 'uploads/Tulips5.jpg', 63);
...
CREATE TABLE IF NOT EXISTS `poll` (
  ...
  `p_quest` varchar(20) NOT NULL,
  `p_alt1` varchar(20) NOT NULL,
  `p_alt2` varchar(20) NOT NULL
...
INSERT INTO `poll` (`p_id`, `p_quest`, `p_alt1`, `p_alt2`) VALUES
(45, '0', '0', '0'),
(46, 'is it', 'Yes', 'No');
...
CREATE TABLE IF NOT EXISTS `poll_ans` (
  `p_ans_id` int(11) NOT NULL,
  `p_id` int(11) NOT NULL,
  `m_id` int(11) NOT NULL,
  `p_ans` varchar(25) NOT NULL
...
INSERT INTO `poll_ans` (`p_ans_id`, `p_id`, `m_id`, `p_ans`) VALUES
(2, 42, 22, 'YES'),
(3, 42, 22, 'NO'),
(4, 42, 22, 'Yes'),
(5, 42, 22, 'Yes'),
...
--
-- Indexes for table `poll_ans`
--
ALTER TABLE `poll_ans`
  ADD PRIMARY KEY (`p_ans_id`);
...
--
ALTER TABLE `member`
  MODIFY `m_id` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
...
--
ALTER TABLE `multimedia`
  MODIFY `media_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
...
--
-- AUTO_INCREMENT for table `poll_ans`
--
ALTER TABLE `poll_ans`
  MODIFY `p_ans_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
